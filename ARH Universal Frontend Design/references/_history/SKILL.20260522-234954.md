...
description: Use when the user asks to design, review, redesign, implement, or quality-check frontend interfaces, UI flows, dashboards, landing pages, prototypes, or design-system decisions; applies context-adaptive design direction with accessibility, performance, responsive-state coverage, and practical validation scripts.
---
...
4. For generated projects, run `pnpm build`, `scripts/audit-accessibility.sh`, and `scripts/performance-budget.sh` where dependencies and browser tooling are available.
